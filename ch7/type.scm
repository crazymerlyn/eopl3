...
(define (type-of exp tenv subst)
  (cases expression exp
         ...
         (qualified-var-exp (m-name var) (an-answer (lookup-qualified-var-in-tenv m-name var tenv) subst))
         (diff-exp (exp1 exp2)
...
(define (type-of-program pgm)
  (cases program pgm
    (a-program (m-defns exp1)
      (cases answer (type-of
                      exp1
                      (add-module-defns-to-tenv m-defns (init-tenv))
                      (empty-subst))
             (an-answer (ty subst)
